...
import com.sort.sort_executors.SortExecutors;
import com.sort.mapping_frame.*;
...
public class ButtonComponent {
    ...
    //初始化绘图面板
    private static MyCanvas defaultCanva;
    ...
    public static JButton getMappingButton() {
        ...
        mappingButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Runnable r = () -> {
                    try {
                        defaultCanva=new MyCanvas();
                        new MappingFrame(defaultCanva);
                    } catch (Exception e1) {
                        e1.printStackTrace();
                    }
                };
    ...
    public static JButton getInputButton() {
        inputButton = new JButton("导入时间文件");
    ...
    public static JButton getOutputButton() {
        outputButton = new JButton("生成时间文件");
