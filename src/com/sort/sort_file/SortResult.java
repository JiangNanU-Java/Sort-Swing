...
public class SortResult {
    ...
    //默认文件和默认目录
    protected static final String DEFAULT_PATH="D:\\Default.txt";
    protected static final String DEFAULT_DIRECTORY="D:\\";
    ...
    //获取对应的单位
    public static String getUnit(String sortType){
        if (sortType=="选择排序"||sortType=="插入排序"||sortType=="合并排序"||sortType=="冒泡排序"){
            return  "s";
        }
        else if (sortType=="希尔排序"||sortType=="快速排序"||sortType=="基数排序"||sortType=="堆排序"){
            return "ms";
        }
